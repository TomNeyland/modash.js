...
const fixtures = {
  ...
  blogPosts: [
    {
      _id: 301,
      title: 'Getting Started with MongoDB Aggregation',
      authorId: 401,
      publishedDate: new Date('2024-01-10'),
      tags: ['mongodb', 'database', 'tutorial'],
      views: 1250,
      likes: 89,
      comments: ['Great tutorial!', 'Very helpful', 'Thanks for sharing'],
    },
    {
      _id: 302,
      ...
      views: 2100,
      likes: 156,
      comments: ['Mind blown!', 'Excellent examples'],
    },
    {
      _id: 303,
      ...
      views: 1875,
      likes: 134,
      comments: ['Very useful', 'Bookmarked!', 'Great insights'],
    },
    {
      _id: 304,
  ...
  socialPosts: [
    ...
    },
    {
      _id: 802,
      userId: 902,
      content: 'Building awesome apps with TypeScript',
      timestamp: new Date('2024-01-16T14:20:00Z'),
      likes: 78,
      shares: 23,
      hashtags: ['typescript', 'development'],
    },
    {
      _id: 803,
      userId: 901,
      content: 'Great conference today on modern web development',
      timestamp: new Date('2024-01-17T16:45:00Z'),
      likes: 32,
      shares: 8,
      hashtags: ['webdev', 'conference'],
    },
  ],
      ...
      const result = Aggo.aggregate(fixtures.orders, [
        ...
        { $unwind: '$product' },
        {
          $group: {
            ...
            avgOrderValue: {
              $avg: { $multiply: ['$quantity', '$product.price'] },
            },
      ...
      const result = Aggo.aggregate(fixtures.blogPosts, [
        { $unwind: '$tags' },
        {
          $group: {
            ...
            avgEngagement: {
              $avg: { $add: ['$views', { $multiply: ['$likes', 10] }] },
            },
      ...
      const result = Aggo.aggregate(fixtures.sensorReadings, [
        {
          $addFields: {
            ...
            humidityAlert: {
              $or: [{ $lt: ['$humidity', 30] }, { $gt: ['$humidity', 60] }],
            },
            locationKey: {
              $concat: [
                '$location.building',
