...
const orders = [
    { customerId: 1, item: 'laptop', price: 1200, quantity: 1, date: new Date('2024-01-15'), category: 'electronics' },
    { customerId: 2, item: 'mouse', price: 25, quantity: 2, date: new Date('2024-01-15'), category: 'electronics' },
    { customerId: 1, item: 'keyboard', price: 75, quantity: 1, date: new Date('2024-01-16'), category: 'electronics' },
    { customerId: 3, item: 'chair', price: 300, quantity: 1, date: new Date('2024-01-16'), category: 'furniture' },
    { customerId: 2, item: 'desk', price: 500, quantity: 1, date: new Date('2024-01-17'), category: 'furniture' },
];
